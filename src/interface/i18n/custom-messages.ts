...
export default {
  ...
  table: {
    ...
    // New translations for the set class dialog
    set_class_menu_item: "Configure Table Style",
    dialog_set_style_title: "Set Table Style",
    dialog_select_style_label: "Select a style",
    dialog_cancel: "Cancel",
    dialog_apply: "Apply",
    class_option_default: "Default",
    class_option_columns_2: "2 Columns Layout",
  },
  text_align: {
